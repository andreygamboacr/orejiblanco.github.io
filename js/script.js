...
function detectLanguage() {
    ...
    // Primero respetamos una elección manual anterior
    const savedLanguage = localStorage.getItem("orejiblanco-language");
    ...
    // Si comienza con "en", usamos inglés
    if (browserLanguage.toLowerCase().startsWith("en")) {
        return "en";
    }

    // Para cualquier otro idioma, español
    return "es";
}
